...
# ------------------------------------------------------------
# Q1 - SEARCH PRODUCTS (already built in day-6)
# ------------------------------------------------------------
...
# --------------------------------------------------------------------
# Q2 - SORT PRODUCTS WITH PRICE AND CATEGORY (already built in day-6)
# --------------------------------------------------------------------
...
# ------------------------------------------------------------
# Q3 - PAGINATE PRODUCTS (already built in day-6)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Q5 - SORT PRODUCTS BY CATEGORY THEN PRICE (ASSIGNMENT-5)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Q6 - BROWSE: SEARCH + SORT + PAGINATE COMBINED (ASSIGNMENT-5)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# BONUS : POST - CREATE ORDER (this is needed for Q4 and Bonus testing)
# ------------------------------------------------------------
@app.post("/orders")
def create_order(
